...
func init() {
	...
	//rootCmd.Flags().StringP("tags", "T", "", "Extra tags to match category,separate by ','")
	//rootCmd.Flags().BoolP("byname", "N", false, "Get posters and save by name")
	//rootCmd.Flags().BoolP("byid", "I", false, "Get posters and save by id")
	//rootCmd.Flags().StringP("root", "R", "./", "root path for store posters.")
